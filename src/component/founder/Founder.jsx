  ...
  return (
    <div className='bg-[black] min-h-[40vh] md:min-h-[50vh]'>
        <div className="w-full h-full bg-[black]">
            ...
            <div className="w-full flex justify-center items-center bg-[black] md:h-[25vh] ">
               <h1 className='text-sm md:h-[16vh] min-h-[15vh] md:pb-0 pt-[4vh] text-justify w-4/5 md:w-[88%] md:text-md text-[white]'> 
