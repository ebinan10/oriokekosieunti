  ...
  return (
    <div className='w-full '>
      <div className="w-full h-[2vh] bg-[#ccc] mx-auto"></div>
       ...
       <div className=" max-w-[85%]   flex flex-col justify-center items-start m-[6vh] gap-3 " >
       <p className='text-justify text-base-100 md:text-2xl text-md font-bold mt-4'> At Nuvie dry Wall and Installations, we offer services not limited to the following </p> <br />
         ...
         <p className='text-justify text-base-100 md:text-xl text-md'>
         2.Framed Partitioning :  Partition walls are usually not load-bearing.
          ...
          whilst allowing freedom of decorative design. <br /></p>
          <p className='text-justify text-base-100 md:text-xl text-md'>
