    ...
    <div className='w-full '>
      <div className="w-full h-[2vh] bg-[#ccc] mx-auto"></div>
       ...
       <p className='text-justify text-base-100 md:text-2xl text-2xl font-bold mt-4'> At Nuvie dry Wall and Installations, we offer services not limited to the following </p> <br />
         <p className='text-justify text-base-100 md:text-xl text-sm'> 1. Ceiling Installation : For your different kinds of ceiling applications, including but not limited to Plasterboard,
         ...
         <p className='text-justify text-base-100 md:text-xl text-sm'>
