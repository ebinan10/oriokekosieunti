...
const About = () => {
  return (
    <div className='w-full  flex-col md:h-[170vh] h-[100vh]  flex justify-center items-center'>
    ...
    referrerpolicy="no-referrer-when-downgrade" className='flex h-full justify-center items-center text-[white]'><h1>Contact US</h1></iframe>
        ...
        <div className="md:full w-[100%] bg-[black] md:h-3/4 h-[70vh] flex md:flex-row flex-col justify-center items-center">
            ...
            <img src={kosunti} alt="" className='w-[30vw] h-1/2'/>
             ...
             <div className="md:w-2/3 w-full h-full flex flex-col justify-center item-center">
              <div className="w-full flex flex-col justify-center md:items-start items-center">
                <h1 className="text-[white] md:text-3xl text-xl md:pt-4">About</h1>
              </div>
