...
const About = () => {
  return (
    <div className='w-full  flex-col md:h-[150vh] h-[100vh]  flex justify-center items-center'>
    ...
    referrerpolicy="no-referrer-when-downgrade" className='flex h-full justify-center items-center md:text-sm text-sm text-[white]'><h1>Contact US</h1></iframe>
        ...
        <div className="md:full w-[100%] bg-[black] md:pt-0  md:h-3/4 h-4/5 flex md:flex-row flex-col m-auto justify-center items-center">
        <div className="md:w-1/3 w-full h-[25vh] md:h-full flex justify-center items-center">
            <img src={kosunti} alt="" className='w-[30vw] md:h-1/2 '/>
             ...
             <div className="md:w-2/3 pb-[5vh] md:pb-0 w-full md:max-h-2/5 max-h-full flex flex-col justify-center item-center">
