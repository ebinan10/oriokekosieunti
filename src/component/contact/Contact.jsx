...
const Contact = () => {
  return (<>
    ...
    title="Mountain of Possibility"
    referrerpolicy="no-referrer-when-downgrade" className='flex h-full justify-center md:text-2xl items-center text-[white]'><h1>Contact US</h1></iframe>
          </div>
        ...
        <div className="md:w-1/3 w-full md:pl-[10vw] md:mt-[5vh] h-full flex justify-center items-center">
            <img src={kosunti} alt="" className='w-[30vw] h-1/2'/>
             ...
             <div className="md:w-2/3 w-full md:h-[90%] h-[60vh] flex flex-col justify-center item-center">
                <h1 className='pb-3 w-full flex md:mt-0  md:justify-start justify-center text-base-100 md:text-2xl text-lg'>Contact</h1>
              <div className="w-full"><h1 className=' md:text-xl text-md text-base-100 '> Mountain of Possibility.</h1>
               </div> 
                <div className="w-full">
                    <h1 className='text-base-100 md:text-md text-sm'>
                    Ado-Ekiti road Erinmo, Erinmo-Ijeshaa <br /> Iwaraja, Osun State.
                    <br /> Lagos – Nigeria. <br />
                   <h3 className='font-italics md:text-md md:m-2 text-sm'> mountainpossibility@gmail.com </h3>
